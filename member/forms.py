...
class UserInfoForm(forms.ModelForm):
    #UserInfo
    gender = forms.DecimalField(label="성별", max_digits=1, decimal_places=0,
                               widget=forms.Select(choices=ch.GENDER, attrs={'style': 'width:200px'}), required=False,
                               initial=0)
    age = forms.DecimalField(label="나이", max_digits=4, decimal_places=0,
